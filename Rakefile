...
task :spec => %w[base_spec adapters:oj adapters:yajl adapters:json_gem adapters:json_pure adapters:json_gem_yajl_compatible adapters:json_pure_yajl_compatible adapters:ok_json adapters:gson adapters:jr_jackson adapters:nsjsonserialization]
